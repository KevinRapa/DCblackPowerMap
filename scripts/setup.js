...
var NS = (function() {
    ...
    return {
        ...
        IMG_CONTAINER_HEIGHT: $('#image_container div').height(), // Used to align images vertically.
 ...
 */
$('#hist_img').on('load', function() {
    var gap = NS.IMG_CONTAINER_HEIGHT - $(this).height();

    $('#image_container div')
        .css('padding-top', (gap > 0 ? gap / 2 : 0) + 'px')
        .fadeTo(0, 1);
});


/**
 * Sets up image so it displays a scroll bar only during mouse-over.
 */
$('#image_container div').on('mouseenter', function() {
...
(function() {
    ...
    var updateInfo = function(data, args) {
        ...
        if (e[NAME] != eTitle.text()) {
            ...
            var imagePath = 'images/historical/' + e[NAME] + ', ' + e[STRT] + '.jpg';
